...
<body class="main" style="
        ...
        background : #dcdcdc;
    ">
    <div style="border-radius: 5px;background:white;height: 100%;padding: 0 45px;">
        ...
        <div style="width:50%;margin: 41px auto;">
            <p style="text-align:center;font-size:16px;margin-bottom:26px;">Click on button for reset your password</p>
        ...
        <div style="padding: 0 10px">
            ...
            <p>please use the following reset Link if button not work : </p>
